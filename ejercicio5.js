...
getTotalRockAlbumsDurations(albums);

function getTotalRockAlbumsDurations(albums) {
  let totalRockAlbumsDurations = 0;
  albums.forEach((album) => {
    if (album.genre === "Rock") {
      totalRockAlbumsDurations += album.duration;
    }
  });

  console.log("Total Rock Albums Durations:", totalRockAlbumsDurations);
}
